		...
		<div class="formular-bd w-75 m-auto opindex">
			...
			<form>
				...
				<div id="dynamic_divs<%out.print(op.getId());%> ">
					<div class="card border-secondary">
						<div class="card opindex">
							<div class="row w-100 mx-auto">
								<div
									class="card-header  text-white color-mosbach pt-2 pb-0 mb-0 col-xs-12 col-xl-6">
								...
								<div
									class="card-header text-white color-mosbach pt2 pb0 mb-0 col-xs-12 col-xl-6">
									<p class="text-right mb-0">
										Dauer:
										<%
										out.print(op.getDate_from() + " - " + op.getDate_to());
									%>
									</p>
								</div>
							</div>
							...
							<div class="card-footer bg-transparent border-secondary"
								...
								%>
								<input class="btn  btn-success btn-block" value="Abstimmen"
									id="voteopbtn"
									onClick="voteopBox(<%out.print(op.getId());%>, 'open');">
								<%
									} else {
								%>
								<div class="row ">
									...
									<div class="col-xs-12 col-xl-6">
										<input class="btn  btn-outline-success btn-block disabled "
											value="bereits Abgestimmt">
									</div>
									<div class="col-xs-12 col-xl-6">
										<a class="btn  btn-secondary btn-block  "
											href="opdetailview.jsp?opinionpollid=<%out.print(op.getId());%>"
											target="_blank">Statistik einsehen</a>
									</div>
									<%
										} else {
									%>
					...
					<div class="voteopBox bg-light text-dark"
						id="voteopBox<%out.print(op.getId());%>">
						<form>
							<img
								src="DisplayImageServlet?id=<%out.print(op.getId());%>&select=2"
								class="mb-2" height="200px" />
							<h5>
								<%
									out.print(op.getTitle());
								%>
