...
<body class="bg">
	...
	<div class="content">
		<div class="formular-bd w-75 mx-auto">
			...
			<form id="regForm" action="CreateBlogProcess" method="post"
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="title">Titel*</label> <input type="text"
							...
							placeholder="Titel (max. 50 Zeichen)" maxlength="50" required>
					</div>


					<div class="form-group col-md-6">
						<label for="inputCategory">Kategorie*</label> <select
							id="inputCategory" name="category" class="form-control" required
							data-error="Bitte wählen Sie eine Kategorie aus.">
				...
				<div class="form-group">
					...
					<textarea class="form-control col-md-12"
						id="exampleFormControlDescription" name=content rows="6"
						placeholder="Beschreibung (max. 500 Zeichen)" required
						data-error="Bitte geben Sie eine Beschreibung ein."
				...
				<div class="custom-file col-md-6" id="chooseFile">
					<input type="hidden" name="user"
						value="<%if (u != null)
				out.print(u.getId());%>" /><br /> <input
						type="file" class="form-control custom-file-input" name="photo"
						id="loadFile" accept="image/x-png,image/gif,image/jpeg"> <label
						for="loadFile" class="custom-file-label">Datei auswählen</label>
					<!-- shows filesname of uploaded file inside the fileselection field -->
					<script>
